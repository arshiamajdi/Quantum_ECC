# Monte Carlo simulation of the Steane code
...
function evaluate_code_decoder(code::Stabilizer, lookup_table, p; samples=100_000)
     ...
     for sample in 1:samples
          ...
          # Check if the correction matches the actual error
          if guess == error
               decoded += 1
          end
     end
...
steane_table = create_lookup_table(code)
...
@time post_ec_error_rates = [
     evaluate_code_decoder(code, steane_table, p; samples=100_000)
